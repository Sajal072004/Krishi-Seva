    ...
    <div className='relative'>
      ...
      <div className='absolute top-[-220px] left-10 w-full h-full flex flex-col justify-center items-start p-8'>
        ...
        <div className='mt-8 flex '>
          <button className='mr-4 bg-white py-3 px-16 rounded-lg text-[#61A629] text-[20px]'>Explore More</button>
          <button className='ml-4 text-white  py-3 px-16 rounded-lg border-2 font-bold text-[20px]'>Top Sellers</button>
        </div>
      </div>
    </div>
  );
